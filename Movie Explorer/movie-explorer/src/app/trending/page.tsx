              ...
              {trending.map((movie) => {
                ...
                return (
                  <div
                    ...
                    className="bg-gray-800/80 backdrop-blur-xl border border-purple-500/20 rounded-2xl overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:border-purple-500/50 cursor-pointer h-full group"
                  >
